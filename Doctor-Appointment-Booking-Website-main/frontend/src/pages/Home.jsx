          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <br />
                <p className='text__para'>  Focus on your mental health first.
    ...
    <section>
      ...
      <div className='container'>
        <div className='lg:w-[470px] mx-auto'>
          ...
          providing the best counselling services
          </h2>
      ...
      <section>
        <div className="container">
          ...
          <div className="xl:w-[670px]">
            ...
            <ul className='pl-4'>
              <li className='text__para mb-3'> 1. Schedule the appointment directly.</li>
              <li className='text__para mb-3'> 2.Search for your counselor here, and contact their clinic.</li>
              <li className='text__para'> 3. View our doctors who are accepting new patients,
